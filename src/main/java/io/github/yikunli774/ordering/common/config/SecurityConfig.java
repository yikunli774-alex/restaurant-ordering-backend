    ...
    SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/menu-items", "/api/v1/menu-items/*").hasAuthority("ROLE_PARTICIPANT")
                        ...
                        .requestMatchers("/api/v1/kitchen/**").hasAnyAuthority("ROLE_MANAGER", "ROLE_KITCHEN")
